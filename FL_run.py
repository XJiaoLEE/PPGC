...
command_template = "cd {remote_directory} && sudo rm -R ../../NetSenseML/data && git pull origin main && make run_large world_size={world_size} rank={rank} mechanism={mechanism} {epsilon_arg} {sparsification_arg} dataset={dataset}"
