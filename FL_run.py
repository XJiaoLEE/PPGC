...
# 动态命令模板，用户可以在运行时修改它
command_template = "pip install scipy && pip install cvxpy && cd {remote_directory} && git pull origin main && make run_MNIST_{mechanism}_master world_size={world_size} rank={rank}"
