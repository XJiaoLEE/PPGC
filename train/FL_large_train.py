...
BATCH_SIZE = 50          # 批大小32 300 FOR MNIST 200 FOR CIFAR100 125 FOR CIFAR10
...
def train_client(global_model, rank, world_size, client_datasets, mechanism='BASELINE', out_bits=1):
    ...
    selected_clients = random.sample(range(total_local_clients), total_local_clients // 20)  # Randomly select half of the clients
