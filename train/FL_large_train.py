...
BATCH_SIZE = 320          # 批大小32 300 FOR MNIST 200 FOR CIFAR100 125 FOR CIFAR10
...
def federated_learning(mechanism):
    ...
    scheduler = torch.optim.lr_scheduler.StepLR(global_optimizer, step_size=10, gamma=0.992)
